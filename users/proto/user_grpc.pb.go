...
type UserServiceClient interface {
	...
	SaveUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*SetUserResponse, error)
}
...
func (c *userServiceClient) SaveUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*SetUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	SaveUser(context.Context, *User) (*SetUserResponse, error)
...
func (UnimplementedUserServiceServer) SaveUser(context.Context, *User) (*SetUserResponse, error) {
